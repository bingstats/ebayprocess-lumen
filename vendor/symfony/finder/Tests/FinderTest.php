...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testFiles()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'DataTest.php', 'test.py', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testDepth()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'DataTest.php', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testName()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('DataTest.php')), $finder->in(self::$tmpDir)->getIterator());

        $finder = $this->buildFinder();
        $finder->name('test.ph*');
        $finder->name('test.py');
        $this->assertIterator($this->toAbsolute(array('DataTest.php', 'test.py')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testRegexName($regex)
    {
        $finder = $this->buildFinder();
        $finder->name($regex);
        $this->assertIterator($this->toAbsolute(array('test.py', 'DataTest.php')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testDate()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'DataTest.php')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testExclude()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('DataTest.php', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreVCS()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('.git', 'foo', 'foo/bar.tmp', 'DataTest.php', 'test.py', 'toto', 'toto/.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo/bar.tmp', 'DataTest.php', 'test.py', 'toto', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreDotFiles()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo', 'foo/bar.tmp', 'DataTest.php', 'test.py', 'toto', 'toto/.git', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo/bar.tmp', 'DataTest.php', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByName()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo bar', 'foo/bar.tmp', 'DataTest.php', 'test.py', 'toto')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByType()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo bar', 'toto', 'foo/bar.tmp', 'DataTest.php', 'test.py')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByAccessedTime()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'DataTest.php', 'toto', 'test.py', 'foo', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByChangedTime()
    {
        ...
        $this->assertIterator($this->toAbsolute(array('toto', 'test.py', 'DataTest.php', 'foo/bar.tmp', 'foo', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIn()
    {
        ...
        $expected = array(
            self::$tmpDir.DIRECTORY_SEPARATOR.'DataTest.php',
    ...
    public function testRelativePathname()
    {
        ...
        $ref = array('DataTest.php', 'toto', 'test.py', 'foo', 'foo'.DIRECTORY_SEPARATOR.'bar.tmp', 'foo bar');
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                $this->assertIterator($this->toAbsolute(array('foo bar', 'DataTest.php', 'test.py')), $finder->getIterator());
