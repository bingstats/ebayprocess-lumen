...
class EbayOrderProcess
{
    const MaxRetry = 7;
    const CRLF              = "\n";
    const Mail_To           = 'xxx.com,xxx.com';
    const Mail_From         = 'ebay_supportxxx.com';
    const Mail_Support      = 'supportxxx.com';
    const Mail_Dev          = 'xxx.com,xxx.com';
    const Mail_Ebay         = 'xxx.com,xxx.com';
    const Mail_Csr          = 'xxx.com,xxx.com';
    const Mail_Someone      = 'xxx.com,xxx.com,zachary.zheng@xxx.com,wendy.xiao@xxx.com';
    const InvPre            = 'E';
    const InvLen            = 7;
    const Channel           = 'ebay';
    const ShippingCostURL   = 'http://xxxxx/rest/shipping/channel';
...
Click <a href="https://www.xxxx.com/signin.php">here</a> to log in and change your password. <br/><br/>
...
xxxx specializes in desktop and server hardware and we ship from six distribution centers located across the United States. We stock a tremendous amount of inventory but we also carry a large selection of special order items not shown on the Website. <br/><br/>

If you are a government, resale, SMB or corporate buyer and would like to work with an account manager on a special order or a request for quotation, you can email us at <a href="mailto:salesxxx.com">salesxxx.com</a> or call us at 1-866-931-2075 ext. 3. Account managers can <b>reserve special order items, offer volume pricing, provide discount freight shipping (over 150 lbs.) for qualified orders, and arrange assembly and delivery for large server deployments</b>. <br/><br/>

If you have any questions, you can email us at <a href="mailto:supportxxx.com">supportxxx.com</a> or visit our <a href="http://www.xxxx.com/contact.php">Contact Us</a> page. <br/><br/>

xxxx Customer Service Team
EOT;
